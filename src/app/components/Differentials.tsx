...
const cards = [
  {
    icon: Gem,
    title: "Elegancia",
    text: "Una barra con estética cuidada, pensada para integrarse al estilo de tu evento.",
  },
  {
    icon: Star,
    title: "Calidad",
    text: "Bebidas, insumos y cocktails seleccionados para una experiencia premium.",
  },
  {
    icon: Users,
    title: "Servicio",
    text: "Atención cercana, profesional y personalizada antes y durante la celebración.",
  },
  {
    icon: Heart,
    title: "Experiencia",
    text: "La barra se convierte en un punto de encuentro, disfrute y recuerdo para los invitados.",
  },
];
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
          ...
          >
            ...
            >
              Una barra con{" "}
              <em style={{ color: "#C8A45D", fontStyle: "italic" }}>nombre propio</em>
            </h2>
        ...
        >
          <div style={{ flex: 1, height: "1px", background: "rgba(58,58,55,0.6)" }} />
          <p
            style={{
              fontFamily: "'Inter', sans-serif",
              color: "#C8A45D",
          ...
          {cards.map((card, i) => (
            <motion.div
              ...
              onMouseEnter={(e) => {
                ...
                el.style.borderColor = "rgba(200,164,93,0.45)";
            ...
            >
              ...
              >
                <card.icon size={20} color="#C8A45D" strokeWidth={1.5} />
              </div>
